...
% If the goal in a broad and rapid surveillance is a high number of sample throughput and analysis, assembly is too cost and time sensitive for large viral genomes. The presented pipelines could be used in a broad context for the use in many laboratories.
